...
class SPConfig:
    ...
    @staticmethod
    def fileToSPConfig(file_path: str, ipAddr = '', port = 5300, zone_transfer_port = 5200, domain = ''):
        """
